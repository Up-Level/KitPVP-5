...
execute as @e[tag=cloneChunkerNew,limit=1] at @s run clone ~ ~ ~ ~15 ~15 ~15 0 16 10000
execute as @e[tag=cloneChunkerNewNew,limit=1] at @s run clone 0 16 10000 16 32 10016 ~ ~ ~
