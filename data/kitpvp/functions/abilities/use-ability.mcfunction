...
execute store success score isHotbar itemData run data get entity @s SelectedItem.tag.Special.Ability
...
execute if score valid itemData matches 2 run function kitpvp:abilities/calculate-ticked

scoreboard players set success itemData 1
execute if score valid itemData matches 2 if score charge.amount itemData matches ..0 run scoreboard players set success itemData 0
...
execute if score valid itemData matches 2 if score isHotbar itemData matches 1 run function kitpvp:abilities/item-data/set/mainhand-data
execute if score valid itemData matches 2 if score isHotbar itemData matches 0 run function kitpvp:abilities/item-data/set/offhand-data
