...
execute if entity @e[tag=found] if score Sneaking abilityData matches 0 if score Success abilityData matches 1 run function kitpvp:abilities/effects/005-tp/spend
