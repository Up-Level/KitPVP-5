summon horse ~ ~ ~ {Tags:["temp","playerEntity"],Tame:1,SaddleItem:{id:saddle,Count:1,tag:{Tags:["Delete"]}},Attributes:[{Name:horse.jump_strength,Base:1},{Name:generic.movement_speed,Base:0.20},{Name:generic.max_health,Base:16}]}
