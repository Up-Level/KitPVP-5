summon minecraft:armor_stand ^ ^-0.675 ^ {Tags:["temp","playerEntity","entity.persistDeath"], Marker:1b, Invisible:1, NoGravity:1b, ArmorItems:[{},{},{},{id:"smooth_stone_slab",Count:1b}],Small:1b}
