summon minecraft:area_effect_cloud ~ ~-0.375 ~ {Age: -2147483648, Duration: -1, WaitTime: -2147483648,Invulnerable:1b,Silent:1b,Tags:["blockPoint","temp","playerEntity"],Passengers:[{id:falling_block,Tags:["blockVisual","temp","playerEntity"],NoGravity:1b,NoAI:1b,Time:-2147483648,BlockState:{Name:"bricks"}},{id:shulker,Tags:["blockBox","temp","playerEntity"],NoAI:1b,Invulnerable:1b,Silent:1b}]}
