...
execute store result entity @e[tag=temp,limit=1] power[0] double 0.007 run scoreboard players get o0 mathf.io
execute store result entity @e[tag=temp,limit=1] power[1] double 0.007 run scoreboard players get o1 mathf.io
execute store result entity @e[tag=temp,limit=1] power[2] double 0.007 run scoreboard players get o2 mathf.io
