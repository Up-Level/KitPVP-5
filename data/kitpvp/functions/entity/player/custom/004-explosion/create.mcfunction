summon firework_rocket ^ ^ ^ {Tags:["temp", "playerEntity","entity.persistRound"],Silent:1b,LifeTime:0,FireworksItem:{id:"firework_rocket",Count:1,tag:{Fireworks:{Flight:1,Explosions:[{Type:0,Flicker:0,Trail:0,Colors:[I;11743532],FadeColors:[I;15435844]}]}}}}
