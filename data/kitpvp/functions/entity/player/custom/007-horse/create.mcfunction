summon horse ~ ~ ~ {Tags:["temp","playerEntity","entity.persistDeath","entity.rideable"],PersistenceRequired:1b,Tame:1,SaddleItem:{id:"minecraft:saddle",Count:1,tag:{Tags:["Delete"]}},Attributes:[{Name:"horse.jump_strength",Base:1},{Name:"generic.movement_speed",Base:0.20},{Name:"generic.max_health",Base:16}]}
