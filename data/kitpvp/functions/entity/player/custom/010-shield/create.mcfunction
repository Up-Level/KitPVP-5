#summon minecraft:armor_stand ~ ~ ~ {Tags: ["temp","playerEntity","entity.persistDeath","Back"],DisabledSlots:16191,Invisible:1b,NoGravity:1b,ArmorItems:[{},{},{},{id:"minecraft:stone",Count:1b,tag:{CustomModelData:10}}]}

summon minecraft:armor_stand ~ ~ ~ {Tags: ["temp","playerEntity","entity.persistDeath","Left"],DisabledSlots:16191,Invisible:1b,NoGravity:1b,ArmorItems:[{},{},{},{id:"minecraft:stone",Count:1b,tag:{CustomModelData:10}}]}

summon minecraft:armor_stand ~ ~ ~ {Tags: ["temp","playerEntity","entity.persistDeath","Right"],DisabledSlots:16191,Invisible:1b,NoGravity:1b,ArmorItems:[{},{},{},{id:"minecraft:stone",Count:1b,tag:{CustomModelData:10}}]}
