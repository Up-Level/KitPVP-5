execute if score @p a2.CD matches -1 run scoreboard players set @s a2.CD 20
...
give @s minecraft:carrot_on_a_stick{Unbreakable:1b,ability2:1b,type:2b,effect:6b} 1
