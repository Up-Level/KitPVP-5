execute if score @p a1.CD matches -1 run scoreboard players set @s a1.CD 20
execute if score @p a1.CDCount matches -1 run scoreboard players operation @s a1.CDCount = @s a1.CD
execute if score @p a1.ChargeMax matches -1 run scoreboard players set @s a1.ChargeMax 20
...
give @s minecraft:carrot_on_a_stick{Unbreakable:1b,ability1:1b,type:1b,effect:5b} 1
