execute if score @s ability1Use matches 1 if score @s a1.CDCount matches 0.. unless score @s a1.ChargeMax = @s a1.ChargeCount run scoreboard players remove @s a1.CDCount 1
execute if score @s ability1Use matches 1 if score @s a1.CDCount matches ..0 run scoreboard players add @s a1.ChargeCount 1
execute if score @s ability1Use matches 1 if score @s a1.CDCount matches ..0 run scoreboard players operation @s a1.CDCount = @s a1.CD
