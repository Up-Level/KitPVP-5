...
execute if entity @s[team=green,tag=!firstInfected] run function kitpvp:loadout/grant-items-preset/grant-items-infected
execute if entity @s[team=green,tag=firstInfected] run function kitpvp:loadout/grant-items-preset/grant-items-infected-prime
