scoreboard players operation timeRemaining gm.general -= #1 mathf.const
...
execute if score timeRemaining gm.general matches 0 run function kitpvp:gamemode/01-deathmatch/end
