...
data modify entity @e[tag=flagGreen,limit=1] Pos set from storage current-map Map.Gamemodes.6.GreenSpawn
...
tag @a[tag=capturingGreenFlag] remove capturingGreenFlag
