data merge storage __temp__ {translation:[0f,0f,0f],scale:[0f,0f,0f]}
...
execute store result storage __temp__ scale[0] float 0.0001 run scoreboard players get scaleFactor temp
execute store result storage __temp__ scale[1] float 0.0001 run scoreboard players get scaleFactor temp
execute store result storage __temp__ scale[2] float 0.0001 run scoreboard players get scaleFactor temp
