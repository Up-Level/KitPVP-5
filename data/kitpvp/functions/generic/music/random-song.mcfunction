...
execute if score @s musicCategory matches 2 run scoreboard players operation songChoice temp %= #3 mathf.const
execute if score @s musicCategory matches 2 run scoreboard players add songChoice temp 10

execute if score @s musicCategory matches 3 run scoreboard players operation songChoice temp %= #7 mathf.const
execute if score @s musicCategory matches 3 run scoreboard players add songChoice temp 20

execute if score @s musicCategory matches 4 run scoreboard players operation songChoice temp %= #5 mathf.const
execute if score @s musicCategory matches 4 run scoreboard players add songChoice temp 30
