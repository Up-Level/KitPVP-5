...
execute if score songChoice temp matches 6 store result score @s remainingLength run data get storage music-06 Duration
...
execute if score songChoice temp matches 5 run playsound custom.music.fight.ultrakill1 record @s
execute if score songChoice temp matches 6 run playsound custom.music.fight.ultrakill2 record @s
