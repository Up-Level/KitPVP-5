...
execute if score @s l.use.arm matches 5 run function kitpvp:loadout/items/armor/items/005-elytra/stop
execute if score @s l.use.arm matches 6 run function kitpvp:loadout/items/armor/items/006-warden/stop
