...
data modify storage kitpvp:ability-data abilityData set value {HudIcon:8,SoftCD:4,Use:{Type:1,Effect:15,FullEffect:16,CancelTime:4,Channel:{Amount:0,Max:120}},Spend:{Type:1,CD:{Amount:0,Max:500},Charge:{Amount:1,Max:1}}}
