...
execute if score @s ability1 matches 1 run function kitpvp:loadout/items/ability1/items/001-shield/start
execute if score @s ability1 matches 2 run function kitpvp:loadout/items/ability1/items/002-totem/start
execute if score @s ability1 matches 3 run function kitpvp:loadout/items/ability1/items/003-smoke-bomb/start
