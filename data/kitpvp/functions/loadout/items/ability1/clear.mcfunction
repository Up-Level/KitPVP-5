...
execute if score @s l.use.a1 matches -4 run function kitpvp:loadout/items/ability1/items/custom/004-magic-shield/clear
execute if score @s l.use.a1 matches -5 run function kitpvp:loadout/items/ability1/items/custom/005-block-disguise/clear