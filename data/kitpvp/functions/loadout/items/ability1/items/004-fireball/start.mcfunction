...
data modify storage kitpvp:ability-data abilityData set value {HudIcon:3,Use:{Type:0,Effect:9,SoftCD:4},Spend:{Type:1,CD:{Amount:0,Max:100},Charge:{Amount:3,Max:3}}}
