...
data modify storage kitpvp:ability-data abilityData set value {HudIcon:6,Use:{Type:0,Effect:10,SoftCD:4},Spend:{Type:1,CD:{Amount:0,Max:100},Charge:{Amount:1,Max:1}}}
