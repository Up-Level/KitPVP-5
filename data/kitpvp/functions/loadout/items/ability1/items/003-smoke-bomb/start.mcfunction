...
data modify storage kitpvp:ability-data abilityData set value {SpendType:1,Effect:7,HudIcon:5,CD:{Amount:0,Max:360},Charge:{Amount:1,Max:1}}
execute store result storage kitpvp:ability-data abilityData.HudId int 6 run scoreboard players get counter idCounter
