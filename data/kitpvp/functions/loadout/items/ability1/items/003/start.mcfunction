...
execute if score @p a1.CD matches -1 run scoreboard players set @s a1.CD 360
...
give @s minecraft:carrot_on_a_stick{Unbreakable:1b,ItemType:"ability1",AbilitySlot:1b,Tags:["Bound"],AbilityEffect:7b,CustomModelData:102,display:{Name:'{"text":"Smoke Bomb","italic":"false"}', Lore:['{"text":"Use to throw a smoke bomb.","color":"gray","italic":"false"}']}} 1
