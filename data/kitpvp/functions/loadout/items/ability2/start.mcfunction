...
execute if score @s l.use.a2 matches 3 run function kitpvp:loadout/items/ability2/items/003-ninja-gear/start
...
execute if score @s l.use.a2 matches -3 run function kitpvp:loadout/items/ability2/items//custom/003-wolf/start