...
data modify storage kitpvp:ability-data abilityData set value {HudIcon:7,SoftCD:4,Use:{Type:0,Effect:11},Spend:{Type:1,CD:{Amount:0,Max:200},Charge:{Amount:1,Max:1}}}
