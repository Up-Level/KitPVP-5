...
give @s minecraft:carrot_on_a_stick{Unbreakable:1b,ItemType:"ability2",AbilitySlot:2b,Tags:["Bound"],AbilityEffect:5b,CustomModelData:100,display:{Name:'{"text":"Portable Teleporter","italic":"false"}', Lore:['{"text":"Use to place and teleport back to a point.","color":"gray","italic":"false"}','{"text":"Sneak+Use to get rid of all points.","color":"gray","italic":"false"}']}} 1
