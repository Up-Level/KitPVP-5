...
data modify storage kitpvp:ability-data abilityData set value {HudIcon:5,SoftCD:4,Use:{Type:0,Effect:7},Spend:{Type:1,CD:{Amount:0,Max:360},Charge:{Amount:1,Max:1}}}
