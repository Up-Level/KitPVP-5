...
give @s minecraft:carrot_on_a_stick{Unbreakable:1b,ItemType:"ability2",AbilitySlot:2b,Tags:["Bound"],AbilityEffect:6b,CustomModelData:101,display:{Name:'{"text":"Builders Blueprints","italic":"false"}', Lore:['{"text":"Use to build a path.","color":"gray","italic":"false"}','{"text":"Sneak+Use to build a wall.","color":"gray","italic":"false"}']}} 1
