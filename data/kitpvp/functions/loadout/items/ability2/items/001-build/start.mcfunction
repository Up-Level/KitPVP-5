...
data modify storage kitpvp:ability-data abilityData set value {HudIcon:1,Use:{Type:0,Effect:6,SoftCD:5},Spend:{Type:1,CD:{Amount:0,Max:140},Charge:{Amount:3,Max:3}}}
