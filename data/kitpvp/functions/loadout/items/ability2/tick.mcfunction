...
execute if score @s ability2 matches 3 run function kitpvp:loadout/items/ability2/items/003-climb/tick
#execute if score @s ability2 matches 4 run function kitpvp:loadout/items/ability2/items/004-horse/tick
