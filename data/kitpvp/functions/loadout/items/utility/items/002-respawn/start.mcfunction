...
data modify storage kitpvp:ability-data abilityData set value {SoftCD:4,Use:{Type:1,Effect:13,FullEffect:14,CancelTime:4,Channel:{Amount:0,Max:200}},Spend:{Type:0}}
