...
execute as @a[scores={giveLoadout=1}] run function kitpvp:loadout/items/all/tick

execute as @a[scores={editLoadout=1}] run function kitpvp:loadout/edit/edit/trigger-tick
