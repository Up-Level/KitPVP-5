...
execute if score @s menuTriggers matches 8 run scoreboard players set @s musicCategory 2
execute if score @s menuTriggers matches 8 run function kitpvp:generic/music/skip-song

execute if score @s menuTriggers matches 9 run scoreboard players set @s musicCategory 0
execute if score @s menuTriggers matches 9 run stopsound @s record
