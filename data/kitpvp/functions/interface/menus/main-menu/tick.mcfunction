...
execute if data entity @s SelectedItem.tag.menuToggle if score @s useFungusStick matches 1 unless entity @s[scores={inMenu=1}] run function kitpvp:interface/menus/main-menu/enable
