...
execute if data entity @s SelectedItem.tag.menuToggle if score @s useFungusStick matches 1 if entity @s[tag=inMenu] run function kitpvp:interface/menus/main-menu/disable

execute if entity @s[tag=inMenu] run function kitpvp:interface/menus/main-menu/display
execute if score @s[tag=inMenu] menuTriggers matches 1.. run function kitpvp:interface/menus/main-menu/triggers
