...
execute if data entity @s SelectedItem.tag.menuToggle if score @s useFungusStick matches 1 if entity @s[scores={inMenu=0}] run function kitpvp:interface/menus/main-menu/enable
