...
execute if data entity @s SelectedItem.tag.menuToggle if score @s bin.fungus matches 1 run function kitpvp:interface/menus/main-menu/enable
execute if entity @s[scores={inMenu=1,menuTriggers=1..}] run function kitpvp:interface/menus/main-menu/triggers

#execute if data entity @s SelectedItem.tag.menuToggle if score @s bin.fungus matches 1 if entity @s[scores={inMenu=1}] run function kitpvp:interface/menus/main-menu/disable
