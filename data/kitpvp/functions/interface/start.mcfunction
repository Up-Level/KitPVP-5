...
execute if score gamemode info matches 1.. if score gamemodeSupported info matches 1 if score playersReady info matches 2.. if score gamemodeActive info matches 0 run function kitpvp:map/load-unload/clone-map
