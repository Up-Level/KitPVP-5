#> mathf:minecraft/sqr-dist-between-entities
# Finds the square distance between two entities.
# More performant in the case where are only comparing distances from each other.
...
function mathf:sqr-dist-between-points
